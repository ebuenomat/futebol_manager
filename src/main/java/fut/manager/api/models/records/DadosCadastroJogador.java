...
public record DadosCadastroJogador(
        @NotBlank String nome, @NotBlank String cpf , String email, LocalDate dataNascimento, Integer idade, Posicao posicao, StatusJogador status, DadosEndereco endereco) {
}
